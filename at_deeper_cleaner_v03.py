...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        icon_path = os.path.join(script_dir, 'icons', 'deeper_cleaner_icon.png')
        ...
        pixmap = QPixmap(os.path.join(script_dir, 'icons', 'deeper_cleaner_icon.png')).scaled(150, 113)
        ...
        logo_label = QLabel()
        logo_pixmap = QPixmap(os.path.join(script_dir, 'icons', 'arc-team_logo.png')).scaled(300, 70)
